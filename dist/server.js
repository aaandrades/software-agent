...
server.registerTool("Get a pokemon", {
    title: "Get a Pokemon",
    ...
    try {
        ...
        return {
            content: [
                {
                    type: "text",
                    text: `Error fetching Pokemon: ${error instanceof Error ? error.message : String(error)}`
                }
            ]
        };
    }
});
// 4️⃣ GitHub create PR tool
